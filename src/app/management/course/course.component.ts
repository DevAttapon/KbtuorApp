...
onSubmit() {
  ...
  const formData = new FormData();
        ...
        formData.append('course_detail', btoa(this.formG.value.course_detail) );
        if (this.imgData) {
...
if ( this.course_id === null ) {
  ...
  const data = {
    ...
    course_detail: btoa(this.formG.value.course_detail),
...
onUpdate(id: any) {
  ...
  //  this.formG.controls.course.setValue(res.data.course_name);
   ...
   this.formG.controls.course_detail.setValue(atob(res.data.course_detail));
  //  this.formG.controls.course_pic.setValue(res.data.course_pic);s
